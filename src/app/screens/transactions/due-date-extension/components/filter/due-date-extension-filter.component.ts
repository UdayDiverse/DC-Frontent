...
@Component({
  selector: 'app-due-date-extension-filter',
  standalone: true,
  imports: [
    FormsModule,
    NgSelectModule,
  ...
  templateUrl: './due-date-extension-filter.component.html',
  styleUrl: './due-date-extension-filter.component.scss',
})
export class DueDateExtensionFilterComponent implements OnInit {
  @Input() filters: any = [];
